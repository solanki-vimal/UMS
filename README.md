...
🔗 [Live Demo](https://solanki-vimal.github.io/UMS/)  
...
1. Clone or download the repository:
   ```bash
   git clone https://github.com/solanki-vimal/UMS.git
   ```
...
- 🔗 LinkedIn: [solanki-vimal](https://www.linkedin.com/in/solanki-vimal/)
